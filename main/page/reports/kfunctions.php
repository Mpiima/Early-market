...
if(substr($_SERVER['REQUEST_URI'],6)==$row_menu->link){$act="active";}
         ...
         echo "<li class='nav-item ".$act."'>
            <a class='nav-link' href='./".$row_menu->link."'>
              <i class='material-icons'>".$row_menu->img."</i>
              <p>".$row_menu->item."</p>
            </a>
          </li>";
...
return "<span style='color:green;'><b>FILTERED ;</b><br></span>";
if(!empty($datefrom)&&!empty($dateto)){$dadate="and ('$datefrom'>=incidentdate && '$dateto'<=incidentdate)"; 
return "<span style='color:maroon;'><i> FROM INCIDENT DATE : </i></span>".$datefrom."<span style='color:maroon;'><i> TO : </i></span>".$dateto."; ";}

elseif(!empty($datefrom)&&empty($dateto)){$dadate="and incidentdate='$datefrom'";
return "<span style='color:maroon;'><i> INCIDENT DATE : </i></span>".$datefrom."; ";}

elseif(empty($datefrom)&&!empty($dateto)){$dadate="and incidentdate='$dateto'";
return "<span style='color:maroon;'><i> INCIDENT DATE : </i></span>".$dateto."; ";}

elseif(empty($datefrom)&&empty($dateto)){$dadate='';}

if(!empty($category)){$dacat="and bigcatid='$category'";
return "<span style='color:maroon;'><i>FORM : </i></span>".$row_scrapc->item2."; ";}else{$dacat='';}

if(!empty($district)){$dadis="and canddist='$district'";
return "<span style='color:maroon;'><i> DISTRICT : </i></span>".$row_scrapd->item2."; ";}else{$dadis='';}

if(!empty($constituency)){$dacon="and candconsist='$constituency'";
return "<span style='color:maroon;'><i> CONSTITUENCY : </i></span>".$row_scrapco->item2."; ";}else{$dacon='';}
