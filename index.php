...
<div class="carousel-item active background_bg" data-img-src="assets/images/shop_banner_img3.jpg" style='width:100%;max-height:230px;height: expression(this.height > 400 ? 400: true);min-height:400px;height: expression(this.height < 400 ? 400: true);'>
...
<div class="carousel-item active background_bg" data-img-src="assets/images/shop_banner_img4.jpg" style='width:100%;max-height:230px;height: expression(this.height > 400 ? 400: true);min-height:400px;height: expression(this.height < 400 ? 400: true);'>
<div class="banner_slide_content banner_content_inner">
<div class="col-lg-7 col-10">
</div>
</div>
...
<?php 
            $result_sliders=$dbh->query("SELECT * FROM sliders");
            $count_sliders=$result_sliders->rowCount();
            $row_sliders=$result_sliders->fetchObject();
            if($count_sliders>0){
                do{ ?>
<div class="carousel-item background_bg" data-img-src="main/pages/uploads/<?php echo $row_sliders->imgName; ?>" style='width:100%;max-height:230px;height: expression(this.height > 400 ? 400: true);min-height:400px;height: expression(this.height < 400 ? 400: true);'>
<div class="banner_slide_content banner_content_inner">
<div class="col-lg-7 col-10">
</div>
</div>
...
}while( $row_sliders=$result_sliders->fetchObject());
}
?>
...
<div class="el_img">
 <img src="assets/images/menu_banner6.jpg" alt="shop_banner_img6"> 
</div>
</a>
</div>
...
<a href="#" class="hover_effect1">
<div class="el_img">
 <img src="assets/images/shop_banner_img10.jpg" alt="shop_banner_img7"> 
</div>
</a>
</div>
</div>
...
<?php 
$result_products=$dbh->query("SELECT * FROM products");
...
<div class="countdown_time countdown_style4 mb-4" data-time="2023/05/22 12:30:15"></div>
</div>
</div>
</div>
<?php }while($row_products=$result_products->fetchObject()); } ?>
