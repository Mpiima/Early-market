            		...
            		<div class="padding_eight_all bg-white">
                        <div class="heading_s1">
                            ...
                            if(isset($_POST['register'])){
                                ...
                                $result_user1=$dbh->query("select * from users where email='$email' && phonenumber='$tel'");
                                $row_user1=$result_user1->fetchObject();
                                $count_user1=$result_user1->rowCount();
                                if($count_user1>0){
                                    echo "<div class='alert alert-danger'>User Details Already Exists, Try again </div>";
                                }else{
                                     //checking password
                                if($password==$cpassword){
                                   ...
                                   echo "<div class='alert alert-danger'>Failed to Register, passwords don't match</div>";
                               }
                                }
