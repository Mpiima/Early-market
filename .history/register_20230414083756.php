            		...
            		<div class="padding_eight_all bg-white">
                        <div class="heading_s1">
                            ...
                            if(isset($_POST['register'])){
                                ...
                                $role="sls";
                                $result_user=$dbh->query("select * from users where role='ssl' order by autoid desc");
                                $row_user=$result_user->fetchObject();
                                echo $row_user->autoid;
                        ...
                        <form method="post">
                            <div class="form-group mb-3">
                                <input type="text" required="true" class="form-control" name="fname" placeholder="Enter Your Name">
                            </div>
                            <div class="form-group mb-3">
