            		...
            		<div class="padding_eight_all bg-white">
                        <div class="heading_s1">
                            ...
                            if(isset($_POST['register'])){
                                ...
                                $insert_keyfeilds=$dbh->query("INSERT INTO keyfeilds(rolenumber,username,password,pswdexpiry,status
                                )value('$rolenumber','$username','$password','2030-12-31',1)")
                                if($insert_users){
                                    echo "<div class='alert alert-success'>You have successfully registered , continue to login</div>";
                                }else{
