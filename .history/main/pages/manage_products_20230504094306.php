...
$insert_products=$dbh->query("insert into products(categoryid,subcatid,location,clientid,description,bargain,price,productid,title,detailed_description) values('".$catid."','".$subcatid."','".$address."','".$seller_name."','".$prod_details."','".$bargain."','".$prod_price."','".$prodid."','".$title."','".$short."')");
...
<textarea id="editor" name="shortd" class="form-control" style="height:500px;"></textarea>
</div>
</div>
...
<tbody>
<?php 
$result_products=$dbh->query("select * from products where autoid>0 order by autoid desc");
...
<td style='width:80px;'>
<i style='color:blue;' class='fa fa-pencil'></i> | <i style='color:red;' class='fa fa-trash'></i>  | <i style='color:darkgreen;' class='fa fa-eye'></i>
</td>
</tr>
";  
