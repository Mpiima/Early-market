...
<?php
        ...
        if($row_sub1->expirydate < $dt){
            echo  '<button type="submit" name="submit_product" onclick="causeAlert()" class="btn btn-sm btn-primary btn-block>Submit</button>';
        }else{
            echo  '<input type="submit" name="submit_product" value="Submit" class="btn btn-sm btn-primary btn-block">  ';
        }
        ?>
...
<tbody>
    ...
    <?php
        ...
        if($row_sub1->expirydate < $dt){
            echo  '<a class="btns btn1" onclick="causeAlert()" href="">EDIT</a> &nbsp; <a class="btns btn2" onclick="causeAlert()" href="">DELETE</a> &nbsp;<a class="btns btn1" onclick="causeAlert()" href="">VIEW MORE</a>';
        }else{
            echo  '<a class="btns btn1"   href="">EDIT</a> &nbsp; <a class=" btns"  href="">DELETE</a> &nbsp;<a class=" btns btn1" href="">VIEW MORE</a>';
        }
        ?>
    </td></tr>
</tbody>
