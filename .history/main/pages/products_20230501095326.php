...
<div class="card-header card-header-primary">
    <div class="row">
      ...
      if (isset($_POST['submitbtn'])) {
        ...
        $insert_products=$dbh->query("INSERT INTO products (title,productid,description,categoryid,subcatid,status,location,price,clientid,more_info,
        detailed_description
        )values('$title','$productid','$description','$categ','$subcat',1,'$location','$price','".$_SESSION['rolenumber']."','$more_info','$detailed_decription')");
        if($insert_products){
