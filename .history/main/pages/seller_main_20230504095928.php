...
<div class="card-header card-header-primary">
    <div class="row">
        ...
        if($row_sub1->expirydate < $dt){
          ...
          echo  '<a class="btn btn-outline" href="products.php" style="color:white">Add Product</a>';
        }
        ?>
...
<td>400</td>
<td>600</td>
<td><i style='color:blue;' class='fa fa-pencil'></i> | <i style='color:red;' class='fa fa-trash'></i>  | <i style='color:orange;' class='fa fa-eye'></i>
</td>
</tr>
";  
