...
<tbody>
    ...
    <?php
        ...
        if($row_sub1->expirydate < $dt){
            echo  '<a class="btn btn-success btns" onclick="causeAlert()" href="">EDIT</a> &nbsp; <a class="btn btn-danger btns" onclick="causeAlert()" href="">DELETE</a> &nbsp;<a class="btn btn-primary btns" onclick="causeAlert()" href="">VIEW MORE</a>';
        }else{
            echo  '<a class="btn btn-success btns"  href="">EDIT</a> &nbsp; <a class="btn btn-danger btns"  href="">DELETE</a> &nbsp;<a class="btn btn-primary btns" href="">VIEW MORE</a>';
        }
        ?>
    </td></tr>
</tbody>
