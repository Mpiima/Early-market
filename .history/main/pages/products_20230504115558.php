...
?>  <script>
var allowed=function(){window.location='products.php';}
...
?>
        ...
        if($row_sub1->expirydate < $dt){
          ...
          echo  '<a type="button" class="btn btn-primary btn btn-outline" data-toggle="modal" data-target=".bd-example-modal-lg" href="" style="color:white">
          <i style="color:orange" class="fa fa-plus"></i>&nbsp;Add Product</a>';
        }
        ?>
