    ...
    <div class="modal-header">
      ...
      if (isset($_POST['submitbtn'])) {
       ...
       echo $tit="pdt";
        ...
        $insert_products=$dbh->query("INSERT INTO products (title,productid,description,categoryid,subcatid,status,location
        )values('$title','$productid','$description','$categ','$subcat',1,'$location')");
        if($insert_products){
...
<textarea id="" name="moreinfo" class="form-control" style="height:300px;"></textarea>
</div>
</div>
...
<textarea id="editor" name="detail" class="form-control" style="height:300px;"></textarea>
</div>
...
<input type="submit" name="submitbtn" id="submitbtn" value="Upload Images" class="btn btn-success">
</div>
 </div>
</div>
<div class="col-md-12"><br></div>
