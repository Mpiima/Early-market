...
$insert_products=$dbh->query("insert into products(categoryid,subcatid,address,clientid,description,location,price,productid) values('".$catid."','".$subcatid."','".$address."','".$seller_name."','".$prod_details."','".$bargain."','".$prod_price."','".$prodid."')");
