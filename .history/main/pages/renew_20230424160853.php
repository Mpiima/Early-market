...
<div class="row">        
        <div class="col-lg-3">
            ...
            <div class="col-lg-3">
                ...
                <input type="text" name="amountt" value="" disabled="disabled"  class="form-control"/>
                ...
                <input type="hidden" name="redirect_url" value="http://early-market.com" id="start-payment-button"/>
            </div>
