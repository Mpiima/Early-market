...
<table id="example" class="table table-striped" style="width:100%">
        ...
        <tbody>
            <?php 
            $result_products=$dbh->query("SLECT * FROM products where clientid='".$_SESSION['rolenumber']."'");
            $count_products=$result_products->rowCount();
            $row_products=$result_products->fetchObject();
            if($count_products>0){
                do{
                ...
                <td><?php echo $row_products->categoryid; ?></td>
                <td><?php echo $row_products->subcatid; ?></td>
