...
<table id="example" class="table table-striped" style="width:100%">
        ...
        if($row_sub1->expirydate < $dt){
            echo  '<a class="btn btn-outline" onclick="causeAlert()" href="" style="color:white"><i class="fa fa-edit"></i></a>';
        }else{
          echo  '<a href="addproducts.php" style="color:white"><i class="fa fa-edit"></i></a>';
        }
        ?>
