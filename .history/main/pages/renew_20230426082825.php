    ...
    <div class="row">
            <div class="col-lg-3">
                ...
                <?php if(isset($_POST['myselect'])){
                    ?>
                <input type="hidden" name="amount" value="<?php echo $_POST['myselect']*4000; ?>"  class="form-control"/>
                <input type="text" name="amountt" value="<?php echo $_POST['myselect']*4000; ?>" disabled="disabled"  class="form-control"/>
                    <?php
                } ?>
            ...
            <div class="col-lg-3">
                ...
                <input type="hidden" name="redirect_url" value="http://localhost/emk/main/pages/renew.php" id="start-payment-button"/>
            </div>
