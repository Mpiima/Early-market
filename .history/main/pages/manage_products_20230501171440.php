...
if($insert_products){ echo "<div class='alert alert-success'>Success: Product added successfully</div>"; }else
 { echo "<div class='alert alert-danger'>Failuere: Product not added</div>"; }
