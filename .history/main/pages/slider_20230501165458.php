        ...
        <tbody>
            ...
            if($count_sliders>0){
                do{
                    ?>
                      <tr>
                <td><img width="25%" src="uploads/sliders/<?php echo $row_sliders->imgName; ?>"></td>
                <td><?php echo $row_sliders->linkto; ?></td>
                <td><?php echo $row_sliders->position; ?></td>
                <td><img src='img/writeonpaper.png' style='width:2%;'> <img src='img/trashbin.png' style='width:2%;'></td>
