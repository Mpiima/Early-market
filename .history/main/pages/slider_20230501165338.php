    ...
    <div class="row">
      ...
      if (isset($_POST['submitbtn'])) {
        ...
        foreach ($_FILES['imageFile']['tmp_name'] as $key => $image) {
            ...
            // save to database
            $query = "INSERT INTO sliders SET imgName='$imageName',clientid='$clientid', status=1, 
            linkto='$link',position='$pos' " ;
            $run = $dbh->query($query);
        }
        if ($result) {
        ...
        <tbody>
            ...
            if($count_sliders>0){
                do{
                    ?>
                      <tr>
                <td><img width="15%" src="uploads/sliders/<?php echo $row_sliders->imgName; ?>"></td>
                <td><?php echo $row_sliders->linkto; ?></td>
                <td><?php echo $row_sliders->position; ?></td>
                <td><img src='img/writeonpaper.png' style='width:50%;'> <img src='img/trashbin.png' style='width:50%;'></td>
