    ...
    <div class="modal-header">
      ...
      if (isset($_POST['submitbtn'])) {
       ...
       echo $tit="pdt";
        ...
        $insert_products=$dbh->query("INSERT INTO products (title,productid,description,categoryid,subcatid,status,location,detailed_description,
        more_info
        )values('$title','$productid','$description','$categ','$subcat',1,'$location','$detail_decription','$more_info')");
        if($insert_products){
