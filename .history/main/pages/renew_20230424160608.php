...
<div class="row">        
        <div class="col-lg-3">
            ...
            <div class="col-lg-3">
                ...
                <input type="text" name="customer[email]" value="<?php echo $_SESSION['email']; ?>" >
                <input type="text" name="tx_ref" value="<?php echo $reference; ?>" />
           
                <input type="text" name="amount" value="<?php echo '4000'; ?>"  class="form-control"/>
                ...
                <select class="form-control" name="currency">
                    ...
                    if($count_currency>0){
                        do{
                            ?>
                            <option value="$row_currency->autoid"><?php echo $row_currency->currency; ?></option>
                            <?php
                ...
                <input type="hidden" name="redirect_url" value="http://early-market.com/main/pages/status_pay.php" id="start-payment-button"/>
            </div>
