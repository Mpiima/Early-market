...
<?php
 $result_productimg =$dbh->query("SELECT * FROM productimg where productid='".$row_products->productid."' order by autoid desc LIMIT 1");
...
<h6 class="product_title"><a href="product-detail"><?php echo $row_products->title; ?></a></h6>
