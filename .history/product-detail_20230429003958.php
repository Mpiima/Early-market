<!DOCTYPE html>
<html lang="en">
<?php include 'include/header.php'; include 'main/pages/connect.php'; ?>
<body>
<?php 
if(isset($_GET['id'])){
    $_GET['id'];
            ...
            <div class="col-lg-6 col-md-6">
                <div class="pr_detail">
                    <div class="product_description">
                        ...
                        <div class="pr_desc">
                            <p>Lorem ipsum dolor sit a enim. Nullam id varius nunc id varius nunc.</p>
                        </div>
                    ...
                    <ul class="product-meta">
                        <li>Seller: <a href="#">Mpiima Collins</a></li>
                        <li>Shop: <a href="#">Shop001</a></li>
                    </ul>
                    <div class="cart_extra">
                        <div class="cart-product-quantity">
                        <div class="cart_btn">
                            <button class="btn btn-success" type="button"><i class="fa fa-phone"></i>+256759722002</button>
                        </div>
                        </div>
                        <div class="cart_btn">
                            <button class="btn btn-primary" type="button"><i class="ion-social-whatsapp"></i>Chart via Whatsp</button>
                        </div>
                    </div>
                    <hr />
