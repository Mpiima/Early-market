                    ...
                    <?php
                     ...
                     if($count_img>0){
                        do{
                            ?>
                      <div class="item">
                            <a href="#" class="product_gallery_item active" data-image="main/pages/uploads/<?php echo $row_productimg->imgName; ?>" data-zoom-image="assets/images/product_zoom_img1.jpg">
