...
$result_product=$dbh->query("SELECT * FROM products WHERE categoryid='".$row_products->categoryid."' ");
$count_product=$result_product->rowCount();
$row_product=$result_product->fetchObject();
if($count_product>0){
    do {
...
<?php
 $result_productimg =$dbh->query("SELECT * FROM productimg where productid='".$row_product->productid."' LIMIT 1 ");
 $row_productimg=$result_productimg->fetchObject();
 echo $row_productimg->imgName;
?>" alt="el_img1">
...
<h6 class="product_title"><a href="product-detail?id=<?php echo $row_product->productid; ?>"><?php echo $row_product->title; ?></a></h6>
<div class="product_price">
<span class="price">UGX <?php echo $row_product->price; ?></span>
</div>
<div class="product_title">
<span class="product_title">  <a style="text-decoration:none;" href = "https://wa.me/<?php
  $row_product->clientid; 
 $result_users=$dbh->query("SELECT * FROM users where rolenumber='".$row_product->clientid."'");
 $row_users=$result_users->fetchObject();
...
<?php }while($row_product=$result_product->fetchObject()); } ?>
